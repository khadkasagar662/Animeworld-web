...
const UserAuthentication = () => {
    ...
    const errorName = error && error.response && error.response.data && error.response.data.name;
    ...
    return (
        <>
            <CustomHead
                description={`Sign up to get more awesome stuff from Animeworld`}
                url={`/userauth`}
                contentTitle={`Sign Up | Animeworld`}
            />
